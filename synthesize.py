...
def main():
	...
	parser.add_argument('--taco_checkpoint', default='/groups/ming/tacotron2/LJSpeech/logs-uncond.7/taco_pretrained/tacotron_model.ckpt-54000', help='Path to model checkpoint')
