...
def main():
	...
	parser.add_argument('--taco_checkpoint', default='/groups/ming/tacotron2/LJSpeech/logs-test-uncond/taco_pretrained/tacotron_model.ckpt-64000', help='Path to model checkpoint')
	...
	parser.add_argument('--manip_vae_dim', default=None, help='The model will synthesize spectrogram with the specified dimensions of the VAE code modified. This variable must be a comma-separated list of dimensions. If None, synthesis will be based on the code generated by the VAE encoder without modification. Considered only when hparams.use_vae=True and GTA=False')
