...
def main():
	...
	parser.add_argument('--taco_checkpoint', default='/groups/ming/tacotron2/Blizzard-2013/logs-adjust_hop_win_size/taco_pretrained/tacotron_model.ckpt-92000', help='Path to model checkpoint')
	parser.add_argument('--wave_checkpoint', default='/groups/ming/tacotron2/Blizzard-2013/logs-Wavenet/taco_pretrained/', help='Path to model checkpoint')
	parser.add_argument('--hparams', default='',
		help='Hyperparameter overrides as a comma-separated list of name=value pairs')
	parser.add_argument('--model', default='Tacotron-2')
	parser.add_argument('--input_dir', default='/groups/ming/tacotron2/Blizzard-2013/data/', help='folder to contain inputs sentences/targets')
	parser.add_argument('--mels_dir', default='/groups/ming/tacotron2/Blizzard-2013/tacotron_output/eval/', help='folder to contain mels to synthesize audio from using the Wavenet')
	parser.add_argument('--output_dir', default='/groups/ming/tacotron2/Blizzard-2013/tacotron_output/', help='folder to contain synthesized mel spectrograms')
